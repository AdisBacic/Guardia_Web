...
const TimeSavingSection = () => {
  return (
    <div className="p-4 mr-4 bg-white  rounded-lg md:p-8 dark:bg-gray-800" id="time-saving" role="tabpanel" aria-labelledby="time-saving-tab">
      <h2 className="mb-5 text-2xl font-extrabold tracking-tight text-gray-900 dark:text-white">Tidsbesparing</h2>
