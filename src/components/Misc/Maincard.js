          ...
          <Fade in={true} timeout={2000}>
            <div className="flex flex-col p-4 leading-normal text-center">
              ...
              <p className="mb-3 text-xl md:text-2xl text-gray-400">
                ...
                hanteras i enlighet med GDPR-förordningarna. Vår applikation
                använder avancerad krypteringsteknik för att skydda användardata
                från obehörig åtkomst eller stöld. Dessutom samlar vi endast in
                den minsta mängden information som behövs för att tillhandahålla
                våra tjänster, och vi delar eller säljer aldrig användardata
                till tredje parter.
              </p>
