...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className="fixed w-full z-20 top-0 start-0 bg-[#090A0F] p-2 items-center">
        <div className="flex flex-wrap md:flex-row mx-auto  justify-between max-w-[1200px]">
          <div
          ...
          >
            ...
            <span className="text-xl font-semibold whitespace-nowrap text-white px-1 mt-2 font-poppins-light">
              Guardia
            </span>
          </div>
          ...
          <div
            className={`flex-grow ${isMenuOpen ? "flex" : "hidden"} md:flex ${
              isMenuOpen ? "justify-end" : "justify-end"
            }`}
            id="navbar-sticky"
          >
            <ul
