  ...
  return (<>
    ...
    <nav className="fixed w-full z-20 top-0 start-0 bg-[#090A0F]">
      <div className="flex flex-wrap md:flex-row mx-auto p-4 justify-between">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="#77d47e" viewBox="0 0 21 18" className='w-8 h-8 pl-1'>
          ...
          <span className="text-xl font-semibold whitespace-nowrap text-white px-1 font-poppins-light">Guardia</span>
        </div>
